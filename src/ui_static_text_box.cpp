#include "include/ui_static_text_box.hpp"

UiStaticTextBox::UiStaticTextBox
...
void UiStaticTextBox::render(SDL_Renderer *renderer) {
  ...
  // just default to black bg for now.
